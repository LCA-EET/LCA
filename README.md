...
<img align="right" src="https://github.com/LCA-EET/LCA/blob/main/BMP/XACORWIN.PNG">
<p>
This mod allows Corwin to be added to the party in Shadows of Amn, and Caelar to be added in Throne of Bhaal. Players can either continue the romance they started with Corwin in Siege of Dragonspear, or they can start a new romance with her after her arrival in Athkatla. The mod adds more than 200 new dialogs spread across the four games of the Bhaalspawn saga. Moreover, there are dozens of new items, quests, and cutscenes to enjoy. <a href="https://github.com/LCA-EET/LCA/blob/main/User%20Guide.pdf" target="_blank">The User Guide</a> includes instructions on how to add Corwin and Caelar to your party.   
</p>
<p>
