...
* Added new dialogs and cutscenes (SoD, SoA), including over a dozen new banters for Corwin and Caelar.
...
* Changed the timer for Corwin's post-rescue intimate encounter from 24 hours to 8 hours and updated the Read Me accordingly.
* Minor improvements to fire giant timer scripting in AR4000.
...
## v1.5.7a 2025-11-08
* Fixed an installer issue affecting SoD playthroughs.
...
## v1.5.5d 2025-10-04
* Fixed a bug in Corwin's Bow that would cause the wrong text to appear when the Entangle proc fired.
