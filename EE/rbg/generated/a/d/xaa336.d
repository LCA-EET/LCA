...
~ THEN BEGIN 0 // from:
  ...
  IF ~~ THEN REPLY @2 /* ~What provender do you provide?~ #15311 */ DO ~StartStore("xaa143",LastTalkedToBy(Myself))
~ EXIT
...
~ THEN BEGIN 1 // from:
  ...
  IF ~~ THEN REPLY @2 /* ~What provender do you provide?~ #15315 */ DO ~StartStore("xaa143",LastTalkedToBy(Myself))
~ EXIT
...
~ THEN BEGIN 2 // from:
  ...
  IF ~~ THEN REPLY @7 /* ~Could you describe to us your provender?~ #15317 */ DO ~StartStore("xaa143",LastTalkedToBy(Myself))
~ EXIT
