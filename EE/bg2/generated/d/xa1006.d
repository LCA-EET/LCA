...
IF ~~ THEN BEGIN 14 // from:
  ...
  IF ~~ THEN EXTERN ~XA1002~ 1
END

IF ~~ THEN BEGIN 15 // from:
  SAY @37 /* ~This is not the time—~ [BD69798] #69798 */
  IF ~~ THEN EXTERN ~XA1002~ 3
END
...
IF ~~ THEN BEGIN 40 // from: 39.0
  ...
  IF ~~ THEN REPLY @73 /* ~Captain Corwin? I can think of no better companion.~ #34318 */ EXTERN ~XA1007~ 22
  IF ~~ THEN REPLY @74 /* ~So we're headed to the nearest tavern, I presume?~ #34319 */ EXTERN ~XA1007~ 20
  IF ~~ THEN REPLY @75 /* ~As I've already had one attempt on my life this night, I will permit it.~ #57853 */ EXTERN ~XA1007~ 21
END
