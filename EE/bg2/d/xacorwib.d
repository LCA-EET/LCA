...
IF ~~ THEN BEGIN XA_WealthTalk3C
	...
	COPY_TRANS XACORWIB XA_WealthTalk3B
END
...
IF ~~ THEN BEGIN XA_WealthTalk5_Int
	...
	COPY_TRANS XACORWIB XA_WealthTalk5
END
...
IF ~~ THEN BEGIN XA_WealthTalk5B
	...
	COPY_TRANS XACORWIB XA_WealthTalk5A
END
...
IF ~~ THEN BEGIN XA_WealthTalk_Romance_4
	...
	= @1941 /* ~I don't know exactly when they started... was it when you courageously lifted the siege on Bridgefort? When you valiantly led the assault against Caelar's forces at Dragonspear? Or when you heroically ventured into Avernus and destroyed Belhifet?~ */
	
	= @1987 /*~My admiration and ... and attraction toward you, turned into something more.~*/
...
APPEND BMAZZY
	IF ~~ THEN BEGIN BCorwinMazzy2_BREAK
		SAY @1006 /* ~It's alright. I know you didn't mean anything by it. Besides, I'm quite happy with the crossbow.~*/
	...
	IF ~~ THEN BEGIN BCorwinMazzy2_RBG
		SAY @1007 /* ~Looks like the others are ready... let's get moving.~ */
	...
	IF ~~ THEN BEGIN XA_MazzyWonCompetition
		SAY @1008 /* ~Thank you, Schael. You're one of the toughest competitors I've faced.~ */
		
		IF ~~ THEN REPLY @1009 /* ~You both performed well. I'm glad to have such skilled companions at my side.~  */
	...
	~ THEN BEGIN XA_Trademeet_Competition_SchaelWon
		SAY @1010 /* ~Schael, congratulations on your victory. That was quite the performance.~ */
...
APPEND BDORN
	IF ~~ THEN BEGIN XA_CorwinDornConflict2
		SAY @1011 /* ~It is not your concern.~ */
	...
	IF ~~ THEN BEGIN XA_CorwinDornConflict4
		SAY @1012 /* ~Laughable, woman. Stand in my way, and your neck will snap as easily as a tree in the midst of a hurricane.~ */
		
		IF ~~ THEN REPLY @1013 /* ~That's enough. Dorn, I don't know what you think exists between us, but I love Schael and nothing is going to change that.~  */
		DO ~
			SetGlobal("XA_LC_CorwinDornConflict", "GLOBAL", 2)
		~
		GOTO XA_ChooseCorwin
		
		IF ~~ THEN REPLY @1014 /* ~Stop it, Dorn. You know my affections lie with you.~ */
		DO ~
			SetGlobal("XA_LC_CorwinDornConflict", "GLOBAL", 2)
		~
	...
	IF ~~ THEN BEGIN XA_ChooseCorwin
		SAY @1015 /* ~Bah! To hell with the lot of you!~ */
...
IF ~~ THEN BEGIN BCorwinAnomen1A
		SAY @1016 /* ~A mother's place is at home with her child, not on the battlefield.~ */
	
		= @1017 /* ~You're a poor example of a parent.~ */
		
		IF ~~ THEN REPLY @1018 /* ~You're out of line Anomen. Knock it off.~ */
		EXTERN XACORWIB BCorwinAnomen1B
		
		IF ~~ THEN REPLY @1019 /* ~(Remain silent)~ */
		EXTERN XACORWIB BCorwinAnomen1B
		
		IF ~
			!Global("XA_LC_CorwinPromoted", "GLOBAL", 1)
			!Global("XA_LC_CorwinRomanceActive", "GLOBAL", 2)
		~ THEN REPLY @1020 /* ~You know little of what you speak. Captain Corwin is a fine mother.~ */
		DO ~
			IncrementGlobal("XA_LC_CorwinOpinionOfPlayer", "GLOBAL", 1)
		~
		EXTERN XACORWIB BCorwinAnomen1B
		...
		IF ~
			Global("XA_LC_CorwinPromoted", "GLOBAL", 1)
			!Global("XA_LC_CorwinRomanceActive", "GLOBAL", 2)
		~ THEN REPLY @1021 /* ~You know little of what you speak. Major Corwin is a fine mother.~ */
		DO ~
			IncrementGlobal("XA_LC_CorwinOpinionOfPlayer", "GLOBAL", 1)
		~
		EXTERN XACORWIB BCorwinAnomen1B
		...
		IF ~
			Global("XA_LC_CorwinRomanceActive", "GLOBAL", 2)
		~ THEN REPLY @1022 /* ~You know little of what you speak. Schael is a fine mother.~ */
		DO ~
			IncrementGlobal("XA_LC_CorwinOpinionOfPlayer", "GLOBAL", 1)
		~
		EXTERN XACORWIB BCorwinAnomen1B
...
//{ Edwin Banters
	...
	CHAIN
		IF ~
			...
			//Gender("Edwin",MALE) --- Commented out to allow randomized banters to progress, even if Edwin is a woman
			IsValidForPartyDialogue("Edwin")
