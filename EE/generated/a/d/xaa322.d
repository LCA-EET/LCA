...
~ THEN BEGIN 0 // from:
  ...
  IF ~~ THEN REPLY @2 /* ~What kind of services do you offer here?~ #15404 */ DO ~StartStore("xaa137",LastTalkedToBy(Myself))
~ EXIT
...
~ THEN BEGIN 1 // from:
  ...
  IF ~~ THEN REPLY @5 /* ~What kind of services do you have to offer?~ #15406 */ DO ~StartStore("xaa137",LastTalkedToBy(Myself))
~ EXIT
...
~ THEN BEGIN 2 // from:
  ...
  IF ~~ THEN REPLY @5 /* ~What kind of services do you have to offer?~ #15409 */ DO ~StartStore("xaa137",LastTalkedToBy(Myself))
~ EXIT
...
IF ~~ THEN BEGIN 3 // from:
  ...
  IF ~~ THEN DO ~StartStore("xaa137",LastTalkedToBy(Myself))
~ EXIT
END
