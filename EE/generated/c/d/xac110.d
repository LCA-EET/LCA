...
IF ~~ THEN BEGIN 2 // from: 1.0 0.1
  ...
  IF ~~ THEN REPLY @10 /* ~Leave her. We've wasted enough time as it is.~ #64624 */ EXTERN ~BDSCHAEL~ 11
END
...
IF ~~ THEN BEGIN 10 // from:
  ...
  IF ~~ THEN REPLY @23 /* ~The crusade is in Baldur's Gate? I thought they were only active north of the Winding Water.~ #64714 */ EXTERN ~XAC107~ 34
  IF ~~ THEN REPLY @24 /* ~The crusade's assassins paid for their arrogance. Their leader must do the same.~ #64715 */ EXTERN ~XAC109~ 7
END

IF ~~ THEN BEGIN 11 // from:
  SAY @25 /* ~We would have you join them. The hero of Baldur's Gate is once again called upon to defend the city.~ #34300 */
  IF ~~ THEN REPLY @26 /* ~I stand ready to answer that call.~ #64720 */ EXTERN ~XAC107~ 38
  IF ~~ THEN REPLY @27 /* ~I nearly died saving it from Sarevok. Why should I tempt fate and death twice?~ #64721 */ EXTERN ~XAC108~ 7
  IF ~~ THEN REPLY @28 /* ~I care nothing for the city, Caelar, or her wretched crusade.~ #64722 */ EXTERN ~XAC108~ 6
END

IF ~~ THEN BEGIN 12 // from:
  SAY @29 /* ~This is no laughing matter, <CHARNAME>. Caelar's zealots clearly mean to see you dead.~ [BD64731] #64731 */
  IF ~~ THEN EXTERN ~XAC107~ 37
END
...
IF ~~ THEN BEGIN 37 // from:
  ...
  IF ~~ THEN EXTERN ~BDIMOEN~ 138
END

IF ~~ THEN BEGIN 38 // from:
  SAY @72 /* ~Clear your mind...~ [BD63929] #63929 */
  IF ~~ THEN EXTERN ~BDIMOEN~ 140
END
