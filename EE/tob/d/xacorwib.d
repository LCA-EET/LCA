APPEND ~XACOR25B~
	...
	~ THEN BEGIN XA_CorwinDornConflict1
		...
		~
		EXTERN BDORN25 XA_CorwinDornConflict2
	END
	//}
	...
	//{ Dialog B-1
		...
		~ THEN BEGIN BCorwinAnomen1A
			...
			DO ~
				...
				SetGlobal("XA_LC_Banter_CorwinAnomenEnd", "GLOBAL", 3)	
			~ 
			EXTERN BANOME25 BCorwinAnomen1A
		END
	//}
	...
	IF ~~ THEN BEGIN XA_CorwinDornConflict3
		...
		IF ~~ THEN
		EXTERN BDORN25 XA_CorwinDornConflict4
	END
	...
	~ THEN BEGIN XA_Trademeet_Competition_MazzyWon
		...
		IF ~~ THEN 
		EXTERN BMAZZY25 XA_MazzyWonCompetition
	END
	//}
...
//{ Corwin Sick Dialogs
	...
	CHAIN
		...
		~
		THEN BAERIE25 BCorwinSickAerie
	...
	CHAIN
		IF ~
			...
			IsValidForPartyDialogue("XACORWIN")
		~
		THEN BJAHEI25 BCorwinSickJaheira
	...
	CHAIN
		...
		~
		THEN BKORGA25 BCorwinSickKorgan
	...
	CHAIN
		IF ~
			...
			IsValidForPartyDialogue("XACORWIN")
		~
		THEN BIMOEN25 BCorwinSickImoen2
...
//{ Mazzy Banters
	...
	//{ Continuation Chains
	CHAIN IF ~~ THEN BMAZZY25 BCorwinMazzy2
	...
	END BMAZZY25 BCorwinMazzy2_BREAK

	CHAIN IF ~~ THEN BMAZZY25 BCorwinMazzy2_RESUME
	...
	END XACOR25B BCorwinMazzy2_End

	CHAIN
		IF ~~ THEN BMAZZY25 XA_TMSignup
	...
	CHAIN
		IF ~~ THEN BMAZZY25 XA_MazzyWonCompetition2
...
//{ HaerDalis Banters
	...
	CHAIN 
		IF ~
			...
			IsValidForPartyDialogue("XACORWIN")
		~
		THEN BHAERD25 BCorwinHaerDalis1_C
	...
	CHAIN 
		IF ~
			...
			IsValidForPartyDialogue("XACORWIN")
		~
		THEN BHAERD25 BCorwinHaerDalis1_M
...
//{ Valygar Banters
	...
	CHAIN
		IF ~
			...
			IsValidForPartyDialogue("Valygar")
		~ THEN BVALYG25 BCorwinValygar3A
...
//{ Keldorn Banters
	...
	CHAIN
		IF ~
			...
			IsValidForPartyDialogue("Keldorn")
		~ THEN BKELDO25 BCorwinKeldornInitial
